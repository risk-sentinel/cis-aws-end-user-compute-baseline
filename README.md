...
curl -LO https://github.com/risk-sentinel/cis-aws-end-user-compute-baseline/releases/download/$VERSION/cis-aws-end-user-compute-v1.2.0-$VERSION.tar.gz

# then, on the isolated side
mkdir -p cis-aws-end-user-compute-v1.2.0 && tar xzf cis-aws-end-user-compute-v1.2.0-$VERSION.tar.gz -C cis-aws-end-user-compute-v1.2.0
cd cis-aws-end-user-compute-v1.2.0
...
```yaml
uses: risk-sentinel/cis-aws-end-user-compute-baseline/.github/workflows/exec-evidence.yml@<version>
with:
  profile_source: archive
  archive_path: ./cis-aws-end-user-compute-v1.2.0-<version>.tar.gz
```
...
```yaml
include:
  - project: <your-org>/cis-aws-end-user-compute-baseline
    ref: <version>
